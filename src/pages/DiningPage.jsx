        ...
        <div className="bg-theme-bg min-h-screen transition-colors duration-300">
            ...
            <div className="relative h-[85vh] w-full overflow-hidden">
                <div className="absolute inset-0">
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-t via-transparent to-transparent ${isDark ? 'from-nordic-dark-900' : 'from-white'
                        }`} />
                </div>
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 max-w-5xl mx-auto">
                    ...
                    >
                        <div className="flex items-center justify-center gap-3 mb-6">
                            <div className="h-px w-12 bg-nordic-gold-500" />
                            <span className="text-nordic-gold-500 uppercase tracking-[0.4em] text-xs md:text-sm font-bold">
                                The Culinary Suite
                            </span>
                            <div className="h-px w-12 bg-nordic-gold-500" />
                        </div>

                        <h1 className={`text-6xl md:text-8xl font-serif mb-8 leading-tight transition-colors duration-500 ${isDark ? 'text-white' : 'text-nordic-dark-900'
                            }`}>
                            Your Home. <br />
                            <span className="italic text-nordic-gold-500">Your Kitchen.</span>
                        </h1>

                        <p className={`text-xl md:text-2xl font-light leading-relaxed max-w-2xl mx-auto mb-10 transition-colors duration-500 ${isDark ? 'text-gray-300' : 'text-nordic-dark-700'
                            }`}>
                            Experience the freedom of a fully equipped chef's kitchen with breathtaking ocean views in every residence.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Button className="bg-nordic-gold-500 text-nordic-dark-900 px-10 py-4 h-auto text-lg font-bold rounded-full">Explore Kitchens</Button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            < sunrise className="text-nordic-gold-500" size={32} />
                        ...
                        <p className="text-theme-muted text-xl mb-10 leading-relaxed font-light">
                            Every Nordic Suites apartment features a state-of-the-art kitchen designed for those who love the art of cooking.
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
                            {[
                                ...
                                <div key={i} className="flex gap-4 p-4 rounded-xl hover:bg-theme-surface transition-colors border border-transparent hover:border-theme-border">
                                    <div className="mt-1">
                                        <Star size={18} className="text-nordic-gold-500 fill-nordic-gold-500" />
                                    </div>
                                    <div>
                    ...
                    >
                        ...
                        <div className="absolute -bottom-10 -left-10 bg-nordic-gold-500 text-nordic-dark-900 p-8 rounded-full w-40 h-40 flex flex-col items-center justify-center text-center shadow-xl rotate-12 hidden md:flex">
            ...
            <Section className="bg-theme-surface/30">
                <div className="text-center mb-20">
                    <span className="text-nordic-gold-500 uppercase tracking-widest text-sm font-bold block mb-4">Resident Privileges</span>
                    <h2 className="text-4xl md:text-6xl font-serif text-theme-text mb-6">Elevated Conveniences</h2>
                    <div className="w-24 h-1 bg-nordic-gold-500 mx-auto" />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    {[
                        ...
                        <motion.div
                            key={idx}
                            whileHover={{ y: -15 }}
                            className="bg-theme-bg p-10 rounded-2xl border border-theme-border flex flex-col items-center text-center group transition-all hover:border-nordic-gold-500 hover:shadow-2xl h-full"
                        >
                            <div className="mb-8 text-nordic-gold-500 p-6 bg-nordic-gold-500/10 rounded-2xl group-hover:bg-nordic-gold-500 group-hover:text-nordic-dark-900 transition-all duration-300 transform group-hover:rotate-6">
                                {service.icon}
                            </div>
                            ...
                            <Button variant="outline" className="w-full py-4 font-bold border-2 rounded-xl group-hover:bg-nordic-gold-500 group-hover:text-black group-hover:border-nordic-gold-500">
                                {service.action}
                            </Button>
                        </motion.div>
                    ))}
            ...
            {/* The Summit Table */}
            <Section>
                <div className="relative rounded-3xl overflow-hidden bg-nordic-dark-900 text-white shadow-2xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        <div className="p-12 md:p-24 flex flex-col justify-center relative z-10">
                            <span className="text-nordic-gold-500 uppercase tracking-widest text-sm font-bold mb-6 block">Skyline Dining</span>
                            ...
                            <div className="flex flex-wrap gap-6">
                                <Button className="bg-nordic-gold-500 text-nordic-dark-900 font-bold px-10 py-4 h-auto rounded-full hover:bg-white transition-colors">Reserve Excellence</Button>
                        ...
                        <div className="relative h-[500px] lg:h-auto overflow-hidden">
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-r from-nordic-dark-900 via-transparent to-transparent hidden lg:block" />
                            <div className="absolute inset-0 bg-gradient-to-t from-nordic-dark-900 via-transparent to-transparent lg:hidden" />
                        </div>
                    </div>
                </div>
            </Section>
