    ...
    if (!suite) {
        return (
            <div className="min-h-screen bg-theme-bg flex flex-col items-center justify-center text-theme-text p-4">
                ...
                <Link to="/suites" className="text-nordic-gold-500 flex items-center gap-2 hover:underline">
    ...
    return (
        <div className="bg-theme-bg min-h-screen pt-24 transition-colors duration-300">
            <Section className="py-12">
                ...
                <Link
                    to="/suites"
                    className="inline-flex items-center gap-2 text-theme-text/60 hover:text-nordic-gold-500 transition-colors mb-8 group"
                >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    >
                        <div className="relative aspect-[4/5] overflow-hidden rounded-3xl shadow-3xl">
                            ...
                            <div className="absolute top-6 left-6">
                                <span className="bg-nordic-dark-900/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 text-white text-xs font-bold tracking-[0.2em] uppercase">
                                    Residency {suite.id}
                                </span>
                            </div>
                        </div>
                    ...
                    >
                        <div className="mb-10">
                            <span className="text-nordic-gold-500 uppercase tracking-[0.3em] text-xs font-black block mb-4">The Collection</span>
                            ...
                            <div className="flex flex-wrap gap-6 text-theme-text/60 mb-8">
                                <div className="flex items-center gap-2">
                                    <Maximize size={18} className="text-nordic-gold-500" />
                                ...
                                <div className="flex items-center gap-2">
                                    <MapPin size={18} className="text-nordic-gold-500" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
                                ...
                                <ul className="space-y-4">
                                    {suite.amenities.map((amenity, idx) => (
                                        <li key={idx} className="flex items-start gap-3">
                                            <CheckCircle2 size={18} className="text-nordic-gold-500 mt-0.5 flex-shrink-0" />
                            ...
                            <div className="space-y-8">
                                <div className="p-8 rounded-3xl bg-theme-surface border border-theme-border shadow-inner">
                                    ...
                                    <p className="text-4xl font-serif text-nordic-gold-600 font-bold mb-6">
                        ...
                        <div className="pt-10 border-t border-theme-border">
                            ...
                            <div className="flex gap-10">
                                <div className="flex flex-col items-center gap-3 group">
                                    <div className="p-4 rounded-2xl bg-theme-surface border border-theme-border group-hover:border-nordic-gold-500 group-hover:text-nordic-gold-500 transition-all duration-300">
                                        <Wifi size={24} />
                                    </div>
